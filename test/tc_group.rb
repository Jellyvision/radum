...
class TC_Group < Test::Unit::TestCase
  def setup
    ...
    @g1a_c1_ad1 = ActiveDirectory::Group.new("staff", @c1_ad1)
    @g1b_c1_ad1 = ActiveDirectory::Group.new("staff", @c1_ad1)
    @g1c_c1_ad1 = ActiveDirectory::Group.new("Staff", @c1_ad1)
    @g1d_c2_ad1 = ActiveDirectory::Group.new("staff", @c2_ad1)
    ...
    @uu1_c1_ad1 = ActiveDirectory::UNIXUser.new("user", @c1_ad1, 1000, 
                                                  @ug1_c1_ad1, "/bin/bash",
                                                  "/home/user")
  end
  ...
  def test_removed_flag_false
    assert_block("Removed flags should be false.") do
      @g1a_c1_ad1.removed == false && @ug1_c1_ad1.removed == false
    end
  end
  
  def test_equal
    assert(@g1a_c1_ad1 == @g1b_c1_ad1, "Should be equal")
  end
  
  def test_equal_name_case
    assert(@g1a_c1_ad1 == @g1c_c1_ad1, "Should be equal")
  end
  
  def test_equal_container_difference
    assert(@g1a_c1_ad1 == @g1d_c2_ad1, "Should be equal")
  end
  
  def test_not_equal_ad
    assert(@g1a_c1_ad1 != @g2_c3_ad2, "Should not be equal")
  end
  
  def test_not_equal_group_unix_group
    assert(@g1a_c1_ad1 != @ug1_c1_ad1, "Should not be equal")
  end
  
  def test_add_user
    assert_block("Should have added exactly one user") do
      @g1a_c1_ad1.add_user @u1_c1_ad1
      @g1a_c1_ad1.add_user @u1_c1_ad1
      @g1a_c1_ad1.users.length == 1
    end
  end
  
  def test_add_user_different_directory_exception
    assert_raise RuntimeError do
      @g1a_c1_ad1.add_user @u2_c3_ad2
    end
  end
  ...
  def test_remove_user_group_removed_from_user
    assert_block("User should have removed group when removed from group") do
      @g1a_c1_ad1.add_user @u1_c1_ad1
      @g1a_c1_ad1.remove_user @u1_c1_ad1
      ! @u1_c1_ad1.groups.find do |group|
        group == @g1a_c1_ad1
      end
    end
  ...
  def test_add_group_self_exception
    assert_raise RuntimeError do
      @g1a_c1_ad1.add_group @g1a_c1_ad1
    end
  end
  
  def test_add_group_other_directory_exception
    assert_raise RuntimeError do
      @g1a_c1_ad1.add_group @g2_c3_ad2
    end
  end
  
  def test_add_group
    assert_block("Group should have added another group") do
      @g1a_c1_ad1.add_group @ug1_c1_ad1
      @g1a_c1_ad1.groups.find do |group|
        group == @ug1_c1_ad1
      end
    end
  end
  ...
  def test_remove_group
    assert_block("Group should have been removed") do
      @g1a_c1_ad1.add_group @ug1_c1_ad1
      @g1a_c1_ad1.remove_group @ug1_c1_ad1
      ! @g1a_c1_ad1.groups.find do |group|
        group == @ug1_c1_ad1
      end
    end
